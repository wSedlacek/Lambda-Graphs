...
~1% outside of any given users extended network
~4.5 average connections between any two users
...
You could weight the friend request to be more likely to send to friends of friends
